...
interface PaymentRow {
  ...
  orders: { classes: { title: string; style: string; share_slug: string } | null; businesses: { name: string } | null } | null;
}

const SELECT = "id, amount_inr, method, status, created_at, profiles (full_name), orders!inner (classes (title, style, share_slug), businesses (name))";
