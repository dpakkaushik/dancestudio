...
$ta = Rpc (Api $a.access_token) "create_business_with_owner" @{ p_name = "Rooms Proof Studio $stamp"; p_type = "studio"; p_area = "Kothrud"; p_city = "Pune"; p_styles = @("Hip-Hop") }
Subscribe-Studio ([string]$ta.id)
$tb = Rpc (Api $orgB.access_token) "create_business_with_owner" @{ p_name = "Other Studio $stamp"; p_type = "studio"; p_area = "Andheri"; p_city = "Mumbai"; p_styles = @("Hip-Hop") }
